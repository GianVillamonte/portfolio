...
**Repository:** `amazon-mine-restoration-analysis`  
**Methods:** linear mixed-effects models, model selection, ecological interpretation, R Markdown  
...
### 🛰️ 2. Landsat vegetation seasonality analysis

**Repository:** `landsat-vegetation-seasonality-analysis`  
**Methods:** Google Earth Engine, Landsat NDVI, Kalman imputation, STL decomposition, R Markdown  
...
**Repository:** `biodiversity-monitoring-impact-analysis`  
...
**Repository:** `species-area-similarity-analysis`  
